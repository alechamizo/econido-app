  ...
  try {
    ...
    for (const line of lines) {
      ...
      try {
        ...
        await sql.unsafe(`
          INSERT INTO "inspections" ("nestboxid", "userid", "fecha", "ocupada", "especie", "num_huevos", "num_pollos", "observaciones", "created_at")
          VALUES ($1, $2, $3, $4, $5, $6, $7, $8, NOW())
        `, [nestBoxId, '1', fechaISO, ocupacion, especie, numHuevos, numPollos, observaciones]);
    ...
    for (const [cajaId, inspection] of inspectionsByBox) {
      ...
      try {
        await sql.unsafe(`
          ...
          WHERE "id" = $3
        `, [estadoActual, ultimaEspecie, nestBoxId]);
        updateCount++;
      } catch (err) {
